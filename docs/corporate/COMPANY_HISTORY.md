...
## AutoBody ERP como primeiro produto consumidor

O AutoBody ERP é o primeiro produto consumidor da KEP.

Ele demonstra o modelo em que um produto utiliza padrões, conhecimento e práticas da plataforma de engenharia sem ter seu código-fonte incorporado à KEP.
