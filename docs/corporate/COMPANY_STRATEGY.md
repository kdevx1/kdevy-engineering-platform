...
## KEP como plataforma reutilizável

A KEP é a plataforma reutilizável de engenharia da empresa.

Ela deve reduzir duplicação, acelerar decisões, orientar agentes de IA, preservar conhecimento e manter padrões técnicos aplicáveis a múltiplos produtos.

## AutoBody ERP como primeiro produto

O AutoBody ERP é o primeiro produto consumidor da KEP.

Sua função estratégica é validar o modelo de consumo da plataforma por um produto real, mantendo separação entre código de produto e ativos estruturais de engenharia.
