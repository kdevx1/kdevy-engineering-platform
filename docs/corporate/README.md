...
- como a empresa pensa engenharia, IA, governança e produtos;
- como a marca deve ser usada em documentação interna;
- quais princípios devem orientar membros e agentes de IA.
...
- `COMPANY_CULTURE.md`: cultura de trabalho, decisão, IA e aprendizado.
- `COMPANY_HISTORY.md`: histórico evolutivo da empresa e dos ativos estratégicos.
- `COMPANY_STRATEGY.md`: estratégia institucional e de produtos.
- `BRAND_GUIDELINES.md`: diretrizes internas de marca.
