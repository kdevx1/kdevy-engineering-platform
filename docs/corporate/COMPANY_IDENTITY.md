...
- padrões técnicos e operacionais;
- práticas de IA aplicadas ao ciclo de engenharia;
- documentação preparada para humanos e agentes de IA.
...
- revisão técnica honesta;
- proteção do conhecimento;
- separação clara entre plataforma, produto e identidade institucional.
...
## Como a empresa pensa governança
...
A empresa não copia código do AutoBody ERP para este repositório.

A empresa não registra dados pessoais sensíveis ou dados privados em documentos institucionais.

A empresa não usa agentes de IA como fonte final de decisão sem responsabilidade humana.
