...
Decisões devem ser orientadas por contexto, impacto, risco, custo de manutenção e alinhamento estratégico.

Quando uma decisão afetar arquitetura, governança, IA, plataforma ou produtos, ela deve ser registrada em ADR, KIP ou documento equivalente.
...
## Como a empresa aprende

A empresa aprende documentando decisões, consolidando padrões, revisando resultados e transformando experiência em conhecimento reutilizável.

Aprendizados relevantes devem sair da memória individual e entrar em documentos, playbooks, glossários, templates ou especificações.
